...
describe('FinishedRaces', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [provideRouter([{ path: 'races/finished', component: FinishedRaces }]), { provide: RaceService, useValue: raceService }]
    });
  ...
  it('should display the first page of races by default', async () => {
    ...
    await expect.element(tester.races).toHaveLength(12);
